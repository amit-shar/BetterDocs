...
import com.intellij.icons.AllIcons;
 ...
 final class Constants {
     ...
     static final String KODE_BEAGLE_SETTINGS = "KodeBeagle Settings";
     static final String EXPAND_TREE = "Expand Tree";
     static final String KODE_BEAGLE = "KodeBeagle";
     ...
     static final String KODEBEAGLE_SEARCH = "/kodebeagle/_search?source=";
     static final String ES_URL_DEFAULT = "http://labs.imaginea.com/kodebeagle";
     ...
     static final String FILETYPE_HELP = "<html><center>Currently KodeBeagle supports "
     ...
     static final String KODEBEAGLE = "Kodebeagle";
